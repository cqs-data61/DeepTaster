...
for k in range(9):
  ...
  filepath2='/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/cifar_test_224/imagenet_squeezenet'
...
for epochsize in epoch_list:
  os.mkdir("/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/pruning_finetuning2/images3/pruning_"+str(epochsize))
  model=torch.load("/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/pruning_finetuning2/models3/resnet_"+str(epochsize)+'.pt')
  model=model.to(device)
  bounds = (0, 1)
  fmodel = fb.PyTorchModel(model, bounds=bounds)
  fmodel = fmodel.transform_bounds((0, 1))
  for k in range(9):
    ...
    attackname="FGSM"
    filepath='/content/drive/MyDrive/Watermark_dnn/temp'
    filepath2="/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/pruning_finetuning2/images3/pruning_"+str(epochsize)
    raw, clipped, is_adv = attack(fmodel,X_test,y_test, epsilons=epsilon)
    for i in range(32):
      plt.figure(num=None, figsize=(4,3), dpi=150)
      plt.figure(figsize = (2,2))
...
import os
import foolbox as fb
datasize_list=[10,30,50,70,80,90,100]
epoch_list=[50, 100,150,200]
for datasize in datasize_list:
  for epochsize in epoch_list:
    os.mkdir("/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/retraining_uniform_resnet/images/resnet"+str(datasize)+'_'+str(epochsize))
    model=torch.load("/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/retraining_uniform_resnet/models/resnet"+str(datasize)+'_'+str(epochsize)+'.pt')
    model=model.to(device)
    bounds = (0, 1)
    fmodel = fb.PyTorchModel(model, bounds=bounds)
    fmodel = fmodel.transform_bounds((0, 1))
    for k in range(9):
      ...
      attackname="FGSM"
      filepath='/content/drive/MyDrive/Watermark_dnn/temp'
      filepath2="/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/retraining_uniform_resnet/images/resnet"+str(datasize)+'_'+str(epochsize)
      raw, clipped, is_adv = attack(fmodel,X_test,y_test, epsilons=epsilon)
      for i in range(32):
        plt.figure(num=None, figsize=(4,3), dpi=150)
        plt.figure(figsize = (2,2))
...
torch.save(model, "/content/drive/MyDrive/Watermark_dnn/cifar_dataset_experiment/pruning_finetuning2/models3/resnet_20.pt")
